...
RSpec.describe "a user can see a stretch for a body part" do
  ...
  it "when they search for a stretch" do
    ...
    body_area_stretch1 = create(:body_area_stretch, stretch: stretch1, body_area: body_area1)
    stretch2 = create(:stretch)
    body_area2 = create(:body_area)
    body_area_stretch2 = create(:body_area_stretch, stretch: stretch2, body_area: body_area2)
